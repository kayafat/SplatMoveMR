...
Wichtige Ordner im Unity-Projekt:
...
Die zentrale Szene des Projekts befindet sich unter:
...
## Unity-Version
Das Projekt wurde mit folgender Unity-Version erstellt: Unity 2022.3.62f3
...
Unity 2022.3.62f3 oder kompatibel
Android Build Support
Meta Quest 3
aktivierter Entwicklermodus auf der Quest 3
USB-Verbindung zwischen PC und Quest 3
OpenXR / Meta XR Setup im Unity-Projekt

## Projekt in Unity öffnen
Unity Hub öffnen → Editor Version 2022.3.62f3 oder kompatible Version bereithalten → unter Add "Add from repository"
Nach dem Herunterladen oder Klonen des Repositorys sollte das Projekt über Unity Hub geöffnet werden.
Dabei den Unity-Projektordner auswählen: SplatMoveMR
...
## Build auf Meta Quest 3
Um die Anwendung auf der Meta Quest 3 zu starten:

1. Unity-Projekt öffnen.
2. Unter Assets → Scenes die Szene SampleScene öffnen.
3. Oben links in Unity öffnen: File → Build Settings
4. Als Plattform auswählen: Android
5. Falls nötig auf Switch Platform klicken.
6. Bei Run Device die angeschlossene Meta Quest 3 auswählen
7. Sicherstellen, dass die Quest 3 per USB verbunden ist und USB-Debugging erlaubt wurde.
8. Anschließend klicken: Build And Run
...
Studienprojekt Gaussian Splatting / Mixed Reality
